...
/* Log / Console tab. These components live in trace-viewer/components/DetailTabs.tsx
   and are shared with the standalone viewer — mirror any change in
   trace-viewer/styles/trace-viewer.css.ts. */
