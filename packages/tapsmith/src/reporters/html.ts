...
export class HtmlReporter implements TapsmithReporter {
  ...
  constructor(options: Record<string, unknown> = {}) {
    this._outputFolder = (options.outputFolder as string) ?? 'tapsmith-report';
...
<title>Tapsmith Test Report</title>
<style>
