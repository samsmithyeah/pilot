...
//! 2. **Host-side test runners** — processes like `TapsmithAgentUITests-Runner`
...
mod tests {
    ...
    /// - `TapsmithAgentUITests-Runner` is an xcodebuild-launched XCTest host
...
14646 11320 /Users/sam/Library/Developer/CoreSimulator/Devices/972FB67E-B94F-40EC-9388-7F3EFB761246/data/Containers/Bundle/Application/F9BAB21E/TapsmithTestApp.app/TapsmithTestApp
...
18050 11320 /usr/bin/curl --max-time 5 https://httpbin.org/get -o /dev/null
 3491 28457 /Users/sam/Library/Developer/CoreSimulator/Devices/5A3A8684-CAFE-BABE-DEAD-BEEF00000000/data/Containers/Bundle/Application/0CD2681B/TapsmithAgentUITests-Runner.app/TapsmithAgentUITests-Runner
...
";
    ...
    fn parses_descendants_of_launchd_sim() {
        ...
        // are 14646 (TapsmithTestApp) and 18050 (curl from `simctl spawn`).
        ...
        //   14646 (TapsmithTestApp, BFS child; also marker-matches)
...
";
    ...
    fn catches_xcodebuild_test_runner_via_marker_only() {
        // TapsmithAgentUITests-Runner (pid 3491) belongs to UDID 5A3A8684...;
